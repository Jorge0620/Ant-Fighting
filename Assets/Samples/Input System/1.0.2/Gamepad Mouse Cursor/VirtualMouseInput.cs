...
public class VirtualMouseInput : MonoBehaviour
{
    ...
    private void TryEnableHardwareCursor()
    {
        ...
        if (m_CursorGraphic != null)
        {
           ...
           // Cursor.SetCursor(cursorTexture, new Vector2(50, 50), UnityEngine.CursorMode.Auto);
        }
    }
    ...
    private void UpdateMotion()
    {
        ...
        if (stickAction == null)
            return;
        stickValue = stickAction.ReadValue<Vector2>();
    ...
    [Space(10)]
    [SerializeField] public InputActionProperty m_StickAction;
    [SerializeField] public InputActionProperty m_LeftButtonAction;
    ...
    public Action<InputAction.CallbackContext> m_ButtonActionTriggeredDelegate;
    private double m_LastTime;
    private Vector2 m_LastStickValue;

    public void OnButtonActionTriggered(InputAction.CallbackContext context)
    {
        if (m_VirtualMouse == null)
            return;
